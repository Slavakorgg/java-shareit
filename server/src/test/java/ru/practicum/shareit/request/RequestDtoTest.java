...
class RequestDtoTest {
    ...
    void testSerializeRequest() throws Exception {
        ...
        ItemResponseToRequestDto itemForRequestDto = new ItemResponseToRequestDto();
    ...
    void testDeserializeRequest() throws Exception {
        ...
        ItemRequestDto requestDto = json.parseObject(jsonContent);
        ...
        ItemResponseToRequestDto item = requestDto.getItems().get(0);
